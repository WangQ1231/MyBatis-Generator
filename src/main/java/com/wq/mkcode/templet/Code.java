package com.wq.mkcode.templet;

import java.util.List;
import java.util.Map;

import com.wq.mkcode.entity.Table;
import com.wq.mkcode.entity.Templet;
	...
	public static void create(Map<String, String> pathMap, Map<String, String> publicMap) {
		...
		for (Templet t : list) {
			...
			} else  //非模板文件直接拷贝
			{
				...
				String newPath = ClientTempletUtil.createContent(codePath + "/" + path + "/" + t.getFileName(), publicMap);
