...
import com.wq.mkcode.templet.Code;
...
public class CodeUtil extends javax.swing.JFrame {
	...
	private void formWindowOpened(java.awt.event.WindowEvent evt) {
		...
		File directory = new File(new File("").getAbsolutePath() + File.separatorChar + "model");//设定为当前文件夹
		...
		final Thread t = new Thread(new Runnable() {
			public void run() {
				try {
					...
					//获取当前文件夹下的模板目录下的所有文件夹
					String basePath = new File("").getAbsolutePath() + File.separatorChar + "model" + File.separatorChar
							+ jComboBox1.getSelectedItem();//设定为当前文
